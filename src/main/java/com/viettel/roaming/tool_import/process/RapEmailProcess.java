...
import com.viettel.roaming.tool_import.import_data.ImportEmailMissingConfig;
import com.viettel.roaming.tool_import.import_data.ImportEmailRapFile;
        ...
        try {
            ...
            for (EmailAccount account : accountList) {
                ...
                for (int i = 0; i < messages.length; i++) {
                    System.out.println("xử lý thư: " + i);
...
//                                }
                        ...
                        if (emailConfig.getEmailConfigId() != null) {
                            // insert pending
                            System.out.println("Xử lý mail RAP");
